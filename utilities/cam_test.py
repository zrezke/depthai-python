...
def set_depthai_timeouts(connection_timeout=30000, boot_timeout=30000):
    """Set timeout env variables before importing depthai"""
    os.environ["DEPTHAI_CONNECTION_TIMEOUT"] = str(connection_timeout)
    os.environ["DEPTHAI_BOOT_TIMEOUT"] = str(boot_timeout)
...
def cam_test(args):
    print(args)
    set_depthai_timeouts(args.connection_timeout, args.boot_timeout)
